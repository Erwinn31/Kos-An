@extends('site.base')
@section('title')All Dormitory | @endsection
@section('content')
  ...
  <section id="showcase-inner" class="py-5 text-white">
    <div class="container">
      <div class="row text-center">
        <div class="col-md-12">
          <h1 class="display-4">Pencarian Kamar Kos</h1>
          <p class="lead">Dapatkan Segera Kamar Idamanmu!</p>
        </div>
      </div>
    </div>
  </section>
          ...
          <div class="card listing-preview">
            ...
            <div class="card-body">
              <div class="listing-heading text-center">
                ...
                <p>
                  <i class="fas fa-map-marker text-secondary"></i> {{ $listing ->city }}, {{ $listing ->country }}</p>
              </div>
              <hr>
